...
ProgramBuildFailedException::ProgramBuildFailedException( boost::compute::opencl_error& opencl_error,
    boost::compute::program& program )
{
    ...
    try // Retrieving these values can cause OpenCL errors, so catch them to write at least something about an error
    {
        ...
        build_options = program.get_build_info<std::string>( CL_PROGRAM_BUILD_OPTIONS,
