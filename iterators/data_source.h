...
Called in this way to distinguish from C++ iterators (although actual implementations
can implement both interfaces, and even encouraged to do it), just another way to do the same
thing.
